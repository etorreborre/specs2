...
trait Specs2Variables:
  ...
  lazy val GUIDE_DIR = s"https://specs2.org/guide/$VERSION"
  lazy val SITE_DIR = s"https://specs2.org/website/$VERSION"
  lazy val API_DIR = s"https://specs2.org/api/$VERSION"
