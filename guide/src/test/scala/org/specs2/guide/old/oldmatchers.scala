...
import mock._
import core._
import matchers.{OptionalMatcherCards, MatcherCards}
...
class HamcrestSpec extends Specification with Grouped with Hamcrest { def is = s2"""
  ...
  object beEven extends BaseMatcher[Int] {
    ...
    def describeTo(description: org.hamcrest.Description) { description.appendText(" is odd") }
  }
...
""" ^
  ("how to use Forms" ~ new org.specs2.guide.old.FormsPage) ^
s2"""
