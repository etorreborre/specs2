...
Sometimes you just want to specify that a block of code is going to terminate. The `${fullName[
    matcher.TerminationMatchers
  ]}` trait is here to help. If you mix in that trait, you can write: ${snippet {
// 8<----
    given ExecutionEnv = ??? // import your own
// 8<----
