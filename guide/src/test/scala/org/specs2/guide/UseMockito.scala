 ...
 * pass all the parameters as an `Array` if the method specifies it:
  `mock.get(0) answers { params: Array[AnyRef] => params.mkString("[", ",", "]") }`

<p/>
In any other cases, if `f` is a function of 1 parameter, the array of the method parameters will be passed (but you might have to cast it)
 and if the function has 2 parameters, the second one will be the mock.
