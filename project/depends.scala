...
object depends {
  ...
  val scalacheck = libraryDependencies += "org.scalacheck" %%% "scalacheck" % "1.18.1"
  val scalacheckTest = libraryDependencies += "org.scalacheck" %%% "scalacheck" % "1.18.1" % Test
  ...
  val junitVintage = "org.junit.vintage" % "junit-vintage-engine" % "5.13.1"
  val junit = libraryDependencies ++= Seq(junitVintage, "org.junit.platform" % "junit-platform-engine" % "1.13.0")
