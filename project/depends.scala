...
object depends {
  ...
  val junitVintage = "org.junit.vintage" % "junit-vintage-engine" % "5.13.0"
  val junit = libraryDependencies ++= Seq(junitVintage, "org.junit.platform" % "junit-platform-engine" % "1.12.2")
