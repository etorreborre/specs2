...
object depends {
  ...
  val junitVintage = "org.junit.vintage" % "junit-vintage-engine" % "5.13.3"
  val junit = libraryDependencies ++= Seq(junitVintage, "org.junit.platform" % "junit-platform-engine" % "1.13.2")
