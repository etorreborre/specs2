...
object depends {
  ...
  def scalaParser = libraryDependencies += "org.scala-lang.modules" %% "scala-parser-combinators" % "2.5.0"

  def scalaXml = libraryDependencies += "org.scala-lang.modules" %% "scala-xml" % "2.5.0"
