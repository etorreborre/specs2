...
trait ScalaCheckPropertyCreation {
  ...
  def prop[T, R](result: T => R)(
    implicit arbitrary: Arbitrary[T], shrink: Shrink[T], pretty: T => Pretty, prettyFreqMap: FreqMap[Set[Any]] => Pretty,
             asResult: AsResult[R], parameters: Parameters, seed: Seed): ScalaCheckFunction1[T, R] =
    ScalaCheckFunction1(result, arbitrary, Some(shrink), collectors = Nil, pretty, prettyFreqMap, asResult, context = None, parameters, seed)
  ...
  def prop[T1, T2, R](result: (T1, T2) => R)(implicit
                                             ...
                                             asResult: AsResult[R], parameters: Parameters, seed: Seed = Seed.random): ScalaCheckFunction2[T1, T2, R] =
    ScalaCheckFunction2(result,
      ...
      asResult, context = None, parameters, seed)
  ...
  def prop[T1, T2, T3, R](result: (T1, T2, T3) => R)(implicit
                                                     ...
                                                     prettyFreqMap: FreqMap[Set[Any]] => Pretty,
                                                     asResult: AsResult[R], parameters: Parameters, seed: Seed = Seed.random): ScalaCheckFunction3[T1, T2, T3, R] =
  ...
  def prop[T1, T2, T3, T4, R](result: (T1, T2, T3, T4) => R)(implicit
                                                             ...
                                                             prettyFreqMap: FreqMap[Set[Any]] => Pretty,
                                                             asResult: AsResult[R], parameters: Parameters, seed: Seed = Seed.random): ScalaCheckFunction4[T1, T2, T3, T4, R] =
  ...
  def prop[T1, T2, T3, T4, T5, R](result: (T1, T2, T3, T4, T5) => R)(implicit
                                                                     ...
                                                                     prettyFreqMap: FreqMap[Set[Any]] => Pretty,
                                                                     asResult: AsResult[R], parameters: Parameters, seed: Seed = Seed.random): ScalaCheckFunction5[T1, T2, T3, T4, T5, R] =
  ...
  def prop[T1, T2, T3, T4, T5, T6, R](result: (T1, T2, T3, T4, T5, T6) => R)(implicit
                                                                             ...
                                                                             prettyFreqMap: FreqMap[Set[Any]] => Pretty,
                                                                             asResult: AsResult[R], parameters: Parameters, seed: Seed = Seed.random): ScalaCheckFunction6[T1, T2, T3, T4, T5, T6, R] =
  ...
  def prop[T1, T2, T3, T4, T5, T6, T7, R](result: (T1, T2, T3, T4, T5, T6, T7) => R)(implicit
                                                                                     ...
                                                                                     prettyFreqMap: FreqMap[Set[Any]] => Pretty,
                                                                                     asResult: AsResult[R], parameters: Parameters, seed: Seed = Seed.random): ScalaCheckFunction7[T1, T2, T3, T4, T5, T6, T7, R] =
  ...
  def prop[T1, T2, T3, T4, T5, T6, T7, T8, R](result: (T1, T2, T3, T4, T5, T6, T7, T8) => R)(implicit
                                                                                             ...
                                                                                             prettyFreqMap: FreqMap[Set[Any]] => Pretty,
                                                                                             asResult: AsResult[R], parameters: Parameters, seed: Seed = Seed.random): ScalaCheckFunction8[T1, T2, T3, T4, T5, T6, T7, T8, R] =
...
object ScalaCheckPropertyCreation {
  ...
  def prop[${TNList(n)}, R](result: (${TNList(n)}) => R)(implicit
    ...
    prettyFreqMap: FreqMap[Set[Any]] => Pretty,
    asResult: AsResult[R], parameters: Parameters, seed: Seed = Seed.random): ScalaCheckFunction$n[${TNList(n)}, R] =
