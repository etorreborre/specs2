...
/** This trait defines functions that are applicable to any DecoratedProperty, i.e. something having a Decorator
  */
private[specs2] trait DecoratedProperties:
  ...
  implicit class decorate[T <: DecoratedProperty[T]](d: T):
    ...
    def bold: T = d.decoratorIs(d.decorator.bold)
...
private[specs2] object DecoratedProperties extends DecoratedProperties
