...
trait DataTables extends ExpectationsCreation:
  ...
  case class Table1[T1](override val titles: List[String], rows: List[DataRow1[T1]], override val execute: Boolean = false, show1: Show1[T1] = Show1[T1]()) extends Table(titles, execute) { outer =>
    def |[S1 >: T1](row: DataRow1[S1])(using s1: Show1[S1] = Show1[S1]()) = Table1(titles, outer.rows :+ row, execute, s1)
    ...
    def executeRowApply[R, M[_]](f: (T1) => M[R], exec: Boolean)(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      if exec then
  ...
  case class Table2[T1, T2](override val titles: List[String], rows: List[DataRow2[T1, T2]], override val execute: Boolean = false, show2: Show2[T1, T2] = Show2[T1, T2]()) extends Table(titles, execute) { outer =>
    def |[S1 >: T1, S2 >: T2](row: DataRow2[S1, S2])(using s2: Show2[S1, S2] = Show2[S1, S2]()) = Table2(titles, outer.rows :+ row, execute, s2)
    ...
    def |@[M[_], R](f: (T1, T2) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, execute)
    def |@>[M[_], R](f: (T1, T2) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, true)
    ...
    def executeRowApply[R, M[_]](f: (T1, T2) => M[R], exec: Boolean)(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      if exec then
  ...
  case class Table3[T1, T2, T3](override val titles: List[String], rows: List[DataRow3[T1, T2, T3]], override val execute: Boolean = false, show3: Show3[T1, T2, T3] = Show3[T1, T2, T3]()) extends Table(titles, execute) { outer =>
    def |[S1 >: T1, S2 >: T2, S3 >: T3](row: DataRow3[S1, S2, S3])(using s3: Show3[S1, S2, S3] = Show3[S1, S2, S3]()) = Table3(titles, outer.rows :+ row, execute, s3)
  ...
  case class Table4[T1, T2, T3, T4](override val titles: List[String], rows: List[DataRow4[T1, T2, T3, T4]], override val execute: Boolean = false, show4: Show4[T1, T2, T3, T4] = Show4[T1, T2, T3, T4]()) extends Table(titles, execute) { outer =>
    def |[S1 >: T1, S2 >: T2, S3 >: T3, S4 >: T4](row: DataRow4[S1, S2, S3, S4])(using s4: Show4[S1, S2, S3, S4] = Show4[S1, S2, S3, S4]()) = Table4(titles, outer.rows :+ row, execute, s4)
    ...
    def |@[M[_], R](f: (T1, T2, T3, T4) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, execute)
    def |@>[M[_], R](f: (T1, T2, T3, T4) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, true)
    ...
    def executeRowApply[R, M[_]](f: (T1, T2, T3, T4) => M[R], exec: Boolean)(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      if exec then
  ...
  case class Table5[T1, T2, T3, T4, T5](override val titles: List[String], rows: List[DataRow5[T1, T2, T3, T4, T5]], override val execute: Boolean = false, show5: Show5[T1, T2, T3, T4, T5] = Show5[T1, T2, T3, T4, T5]()) extends Table(titles, execute) { outer =>
    def |[S1 >: T1, S2 >: T2, S3 >: T3, S4 >: T4, S5 >: T5](row: DataRow5[S1, S2, S3, S4, S5])(using s5: Show5[S1, S2, S3, S4, S5] = Show5[S1, S2, S3, S4, S5]()) = Table5(titles, outer.rows :+ row, execute, s5)
  ...
  case class Table6[T1, T2, T3, T4, T5, T6](override val titles: List[String], rows: List[DataRow6[T1, T2, T3, T4, T5, T6]], override val execute: Boolean = false, show6: Show6[T1, T2, T3, T4, T5, T6] = Show6[T1, T2, T3, T4, T5, T6]()) extends Table(titles, execute) { outer =>
    def |[S1 >: T1, S2 >: T2, S3 >: T3, S4 >: T4, S5 >: T5, S6 >: T6](row: DataRow6[S1, S2, S3, S4, S5, S6])(using s6: Show6[S1, S2, S3, S4, S5, S6] = Show6[S1, S2, S3, S4, S5, S6]()) = Table6(titles, outer.rows :+ row, execute, s6)
    ...
    def |@[M[_], R](f: (T1, T2, T3, T4, T5, T6) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, execute)
    def |@>[M[_], R](f: (T1, T2, T3, T4, T5, T6) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, true)
    def |*[R](f: (T1, T2, T3, T4, T5, T6) => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] =
      executeRowApply((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6) => Future(f(t1,t2,t3,t4,t5,t6))(ec), execute).run
    def |*>[R](f: (T1, T2, T3, T4, T5, T6) => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] =
      executeRowApply((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6) => Future(f(t1,t2,t3,t4,t5,t6))(ec), true).run
    def executeRowApply[R, M[_]](f: (T1, T2, T3, T4, T5, T6) => M[R], exec: Boolean)(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      if exec then
  ...
  case class Table7[T1, T2, T3, T4, T5, T6, T7](override val titles: List[String], rows: List[DataRow7[T1, T2, T3, T4, T5, T6, T7]], override val execute: Boolean = false, show7: Show7[T1, T2, T3, T4, T5, T6, T7] = Show7[T1, T2, T3, T4, T5, T6, T7]()) extends Table(titles, execute) { outer =>
    def |[S1 >: T1, S2 >: T2, S3 >: T3, S4 >: T4, S5 >: T5, S6 >: T6, S7 >: T7](row: DataRow7[S1, S2, S3, S4, S5, S6, S7])(using s7: Show7[S1, S2, S3, S4, S5, S6, S7] = Show7[S1, S2, S3, S4, S5, S6, S7]()) = Table7(titles, outer.rows :+ row, execute, s7)
    ...
    def |@[M[_], R](f: (T1, T2, T3, T4, T5, T6, T7) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, execute)
    def |@>[M[_], R](f: (T1, T2, T3, T4, T5, T6, T7) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, true)
    def |*[R](f: (T1, T2, T3, T4, T5, T6, T7) => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] =
      executeRowApply((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7) => Future(f(t1,t2,t3,t4,t5,t6,t7))(ec), execute).run
    def |*>[R](f: (T1, T2, T3, T4, T5, T6, T7) => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] =
      executeRowApply((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7) => Future(f(t1,t2,t3,t4,t5,t6,t7))(ec), true).run
    def executeRowApply[R, M[_]](f: (T1, T2, T3, T4, T5, T6, T7) => M[R], exec: Boolean)(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      if exec then
  ...
  case class Table8[T1, T2, T3, T4, T5, T6, T7, T8](override val titles: List[String], rows: List[DataRow8[T1, T2, T3, T4, T5, T6, T7, T8]], override val execute: Boolean = false, show8: Show8[T1, T2, T3, T4, T5, T6, T7, T8] = Show8[T1, T2, T3, T4, T5, T6, T7, T8]()) extends Table(titles, execute) { outer =>
    def |[S1 >: T1, S2 >: T2, S3 >: T3, S4 >: T4, S5 >: T5, S6 >: T6, S7 >: T7, S8 >: T8](row: DataRow8[S1, S2, S3, S4, S5, S6, S7, S8])(using s8: Show8[S1, S2, S3, S4, S5, S6, S7, S8] = Show8[S1, S2, S3, S4, S5, S6, S7, S8]()) = Table8(titles, outer.rows :+ row, execute, s8)
    ...
    def |@[M[_], R](f: (T1, T2, T3, T4, T5, T6, T7, T8) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, execute)
    def |@>[M[_], R](f: (T1, T2, T3, T4, T5, T6, T7, T8) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, true)
    def |*[R](f: (T1, T2, T3, T4, T5, T6, T7, T8) => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] =
      executeRowApply((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8) => Future(f(t1,t2,t3,t4,t5,t6,t7,t8))(ec), execute).run
    def |*>[R](f: (T1, T2, T3, T4, T5, T6, T7, T8) => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] =
      executeRowApply((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8) => Future(f(t1,t2,t3,t4,t5,t6,t7,t8))(ec), true).run
    def executeRowApply[R, M[_]](f: (T1, T2, T3, T4, T5, T6, T7, T8) => M[R], exec: Boolean)(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      if exec then
  ...
  case class Table9[T1, T2, T3, T4, T5, T6, T7, T8, T9](override val titles: List[String], rows: List[DataRow9[T1, T2, T3, T4, T5, T6, T7, T8, T9]], override val execute: Boolean = false, show9: Show9[T1, T2, T3, T4, T5, T6, T7, T8, T9] = Show9[T1, T2, T3, T4, T5, T6, T7, T8, T9]()) extends Table(titles, execute) { outer =>
    def |[S1 >: T1, S2 >: T2, S3 >: T3, S4 >: T4, S5 >: T5, S6 >: T6, S7 >: T7, S8 >: T8, S9 >: T9](row: DataRow9[S1, S2, S3, S4, S5, S6, S7, S8, S9])(using s9: Show9[S1, S2, S3, S4, S5, S6, S7, S8, S9] = Show9[S1, S2, S3, S4, S5, S6, S7, S8, S9]()) = Table9(titles, outer.rows :+ row, execute, s9)
    ...
    def |@[M[_], R](f: (T1, T2, T3, T4, T5, T6, T7, T8, T9) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, execute)
    def |@>[M[_], R](f: (T1, T2, T3, T4, T5, T6, T7, T8, T9) => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      executeRowApply(f, true)
    def |*[R](f: (T1, T2, T3, T4, T5, T6, T7, T8, T9) => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] =
      executeRowApply((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8, t9: T9) => Future(f(t1,t2,t3,t4,t5,t6,t7,t8,t9))(ec), execute).run
    def |*>[R](f: (T1, T2, T3, T4, T5, T6, T7, T8, T9) => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] =
      executeRowApply((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8, t9: T9) => Future(f(t1,t2,t3,t4,t5,t6,t7,t8,t9))(ec), true).run
    def executeRowApply[R, M[_]](f: (T1, T2, T3, T4, T5, T6, T7, T8, T9) => M[R], exec: Boolean)(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =
      if exec then
  ...
  case class Table10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10](override val titles: List[String], rows: List[DataRow10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10]], override val execute: Boolean = false, show10: Show10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10] = Show10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10]()) extends Table(titles, execute) { outer =>
    def |[S1 >: T1, S2 >: T2, S3 >: T3, S4 >: T4, S5 >: T5, S6 >: T6, S7 >: T7, S8 >: T8, S9 >: T9, S10 >: T10](row: DataRow10[S1, S2, S3, S4, S5, S6, S7, S8, S9, S10])(using s10: Show10[S1, S2, S3, S4, S5, S6, S7, S8, S9, S10] = Show10[S1, S2, S3, S4, S5, S6, S7, S8, S9, S10]()) = Table10(titles, outer.rows :+ row, execute, s10)
    ...
    def |*[R](f: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] =
      executeRowApply((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8, t9: T9, t10: T10) => Future(f(t1,t2,t3,t4,t5,t6,t7,t8,t9,t10))(ec), execute).run
    def |*>[R](f: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] =
      executeRowApply((t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8, t9: T9, t10: T10) => Future(f(t1,t2,t3,t4,t5,t6,t7,t8,t9,t10))(ec), true).run
  ...
  def tableClasses(n: Int) =
    (1 to n).map { i =>
      List("case class Table"+i+types(i)+"(override val titles: List[String], rows: List["+dataRow(i)+"], override val execute: Boolean = false, "+s"show$i: Show$i${types(i)} = Show$i${types(i)}()"+") extends "+
        ...
        "  def |"+st(i)+"(row: "+dataRow(i, letter="S")+")(using s"+i+": Show"+i+types(i, letter = "S")+" = Show"+i+types(i, letter = "S")+"()) = "+table(i)+"(titles, outer.rows :+ row, execute, s"+i+")",
        ...
        "    else DecoratedResult(DataTable(titles, Seq[DataTableRow]()), Success(\"ok\"))",
        "  }",
        "  def |@[M[_], R](f: "+typesTuple(i)+" => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =",
        "    executeRowApply(f, execute)",
        "  def |@>[M[_], R](f: "+typesTuple(i)+" => M[R])(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] =",
        "    executeRowApply(f, true)",
        "  def |*[R](f: "+typesTuple(i)+" => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] = ",
        "    executeRowApply("+parametersList(i: Int)+" => Future(f("+(1 to i).map("t"+_).mkString(",")+"))(ec), execute).run",
        "  def |*>[R](f: "+typesTuple(i)+" => R)(using asResult: AsResult[R], ec: ExecutionContext): DecoratedResult[DataTable] = ",
        "    executeRowApply("+parametersList(i: Int)+" => Future(f("+(1 to i).map("t"+_).mkString(",")+"))(ec), true).run",
        "  def executeRowApply[R, M[_]](f: "+typesTuple(i)+" => M[R], exec: Boolean)(using asResult: AsResult[R], app: Applicative[M]): M[DecoratedResult[DataTable]] = {",
        "    if (exec)",
  ...
  def dataRowClasses(n: Int) =
    (1 to n).map { i =>
      List(
        ...
        if i < n then "  def ![S"+(i+1)+"](t"+(i+1)+": S"+(i+1)+") = "+"DataRow"+(i+1)+parameters(i+1) else "",
        if i < n then "  def !![S"+(i+1)+"](t"+(i+1)+": S"+(i+1)+") = "+"DataRow"+(i+1)+parameters(i+1) else "",
        "}").mkString("\n")
    }.mkString("\n")
