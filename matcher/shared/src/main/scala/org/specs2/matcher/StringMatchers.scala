...
case class StringMatcher(m: AdaptableMatcher[Any]) {
  private def ignoringCase(a:Any) = a.toString + ", ignoring case"
  private def ignoringSpace(a:Any) = a.toString + ", ignoring space"
  private def isTrimmed(a:Any) = a.toString+ ", trimmed"
