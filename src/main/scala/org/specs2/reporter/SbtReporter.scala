...
class SbtResultOutput(val loggers: Array[Logger]) extends TextResultOutput with SbtLoggers {
  override def printSpecStartName(message: String, stats: Stats)(implicit args: Arguments)  = logInfo   (loggers)(message)
  override def printSpecStartTitle(message: String, stats: Stats)(implicit args: Arguments) = logInfo   (loggers)(message)
  override def printFailure(message: String)(implicit args: Arguments)                      = logFailure(loggers)(message)
  override def printError(message: String)(implicit args: Arguments)                        = logError  (loggers)(message)
  override def printSuccess(message: String)(implicit args: Arguments)                      = logInfo   (loggers)(message)
  override def printStats(message: String)(implicit args: Arguments)                        = logInfo   (loggers)(message)
  override def printLine(message: String)(implicit args: Arguments)                         = logInfo   (loggers)(message)
  override def printText(message: String)(implicit args: Arguments)                         = logInfo   (loggers)(message)
}
