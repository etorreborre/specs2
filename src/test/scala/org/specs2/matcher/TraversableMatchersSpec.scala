...
class TraversableMatchersSpec extends Specification { def is =
  ...
  "we can check if one or several elements are present in an traversable"                                                  ^
    ...
    "with a subclass"                                                                                                   ! subclass().e1^
                                                                                                                        p^
  "we can check if at least one or several elements are present in an traversable"                                         ^
  ...
  "we can check the size of an traversable"                                                                                ^
    ...
    { List(1, 2) must have size(2) }                                                                                    ^
                                                                                                                        p^
  "we can check if an traversable contains elements following a given pattern"                                             ^
    { List("Hello", "World") must containMatch("ll") }                                                                  ^
    { List("Hello", "World") must containPattern(".*llo") }                                                             ^
                                                                                                                        p^
  "we can check if an traversable contains elements with a pattern only once"                                              ^
    ...
    "or if there's more than one"                                                                                       ! patternMatch().fail2^
                                                                                                                        p^
  "we can check if an traversable contains an element with a given property"                                               ^
    { List("Hello", "World") must have(_.size >= 5) }                                                                   ^
    { List("Hello", "World") must not have((_:String).size < 3) }                                                       ^
                                                                                                                        p^
  "we can check if an traversable has the same elements as another one"                                                    ^
