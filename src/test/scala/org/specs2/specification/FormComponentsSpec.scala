...
class FormComponentsSpec extends Specification with Forms { def is =
                                                                                                                        """
...
several ways of creating forms to support the specification of domain objects or services:
