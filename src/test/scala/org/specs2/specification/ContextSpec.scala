...
trait ContextData extends StandardResults with FragmentsBuilder with ContextsForFragments with Contexts {
  ...
  def ex1BeforeThenBefore2 = "ex1" ! (before andThen before2)(ok1)
  def ex1AfterComposeAfter2 = "ex1" ! (after compose after2)(ok1)  
  def ex1AfterThenAfter2 = "ex1" ! (after andThen after2)(ok1)
  ...
  def ex1AroundThenAround2 = "ex1" ! (around andThen around2)(ok1)
