...
class LocationSpec extends Specification {
  ...
  "The FragmentsFragment::def ^(t: String) = fs add Text(t) method must be at line 157. Check the FragmentsBuilder file and fix the Location.scala code" >> {
    val lines = Source.fromFile("src/main/scala/org/specs2/specification/FragmentsBuilder.scala").getLines.toSeq
    // line 156 is index 155
