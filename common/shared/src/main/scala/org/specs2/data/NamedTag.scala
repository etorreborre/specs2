...
/** A tag with names.
  *
  * Given a list of names and the current arguments this tag must be able to determine if what it is tagging must be
  * kept or not
  */
...
/** This tag will always keep its tagged element.
  *
  * It is used to keep setup/teardown behaviour in specification whether examples are tagged or not and whatever is
