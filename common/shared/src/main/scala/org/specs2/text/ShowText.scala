...
open case class Show1[T1](show1: T1 => String = (_: T1).notNull):
  ...
  def show10[T2, T3, T4, T5, T6, T7, T8, T9, T10](
      show10: T10 => String
  ): Show10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10] =
    Show10(
      show1,
      (_: T2).notNull,
      (_: T3).notNull,
...
open case class Show3[T1, T2, T3](
    show1: T1 => String = (_: T1).notNull,
    show2: T2 => String = (_: T2).notNull,
    show3: T3 => String = (_: T3).notNull
):
...
open case class Show4[T1, T2, T3, T4](
    show1: T1 => String = (_: T1).notNull,
    show2: T2 => String = (_: T2).notNull,
    show3: T3 => String = (_: T3).notNull,
    show4: T4 => String = (_: T4).notNull
):
...
open case class Show5[T1, T2, T3, T4, T5](
    show1: T1 => String = (_: T1).notNull,
    show2: T2 => String = (_: T2).notNull,
    show3: T3 => String = (_: T3).notNull,
    show4: T4 => String = (_: T4).notNull,
    show5: T5 => String = (_: T5).notNull
):
...
open case class Show6[T1, T2, T3, T4, T5, T6](
    show1: T1 => String = (_: T1).notNull,
    show2: T2 => String = (_: T2).notNull,
    show3: T3 => String = (_: T3).notNull,
    show4: T4 => String = (_: T4).notNull,
    show5: T5 => String = (_: T5).notNull,
    show6: T6 => String = (_: T6).notNull
):
...
open case class Show7[T1, T2, T3, T4, T5, T6, T7](
    show1: T1 => String = (_: T1).notNull,
    show2: T2 => String = (_: T2).notNull,
    show3: T3 => String = (_: T3).notNull,
    show4: T4 => String = (_: T4).notNull,
...
open case class Show8[T1, T2, T3, T4, T5, T6, T7, T8](
    show1: T1 => String = (_: T1).notNull,
    show2: T2 => String = (_: T2).notNull,
    show3: T3 => String = (_: T3).notNull,
    show4: T4 => String = (_: T4).notNull,
...
open case class Show9[T1, T2, T3, T4, T5, T6, T7, T8, T9](
    show1: T1 => String = (_: T1).notNull,
    show2: T2 => String = (_: T2).notNull,
    show3: T3 => String = (_: T3).notNull,
    show4: T4 => String = (_: T4).notNull,
...
case class Show10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10](
    show1: T1 => String = (_: T1).notNull,
    show2: T2 => String = (_: T2).notNull,
    show3: T3 => String = (_: T3).notNull,
    show4: T4 => String = (_: T4).notNull,
