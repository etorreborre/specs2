...
/** This trait defines the colors which can be used to output text on the console
  *
  * The textColor ... statsColor define the AnsiColor to use The text ... stats methods taking a String as a parameter
  * are inserting control characters to change the string color
  */
trait Colors:
