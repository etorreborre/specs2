...
lazy val common = crossProject(platforms *)
...
lazy val core = crossProject(platforms *)
  .withoutSuffixFor(jvm)
  .in(file("core"))
...
lazy val examples = crossProject(jvmJsPlatforms *)
  .withoutSuffixFor(jvm)
  .in(file("examples"))
...
lazy val fp = crossProject(platforms *)
  .withoutSuffixFor(jvm)
...
lazy val junit = crossProject(jvmJsPlatforms *)
  .withoutSuffixFor(jvm)
  .crossType(CrossType.Pure)
  .in(file("junit"))
...
lazy val matcher = crossProject(platforms *)
  .withoutSuffixFor(jvm)
  .in(file("matcher"))
...
lazy val matcherExtra = crossProject(platforms *)
  .withoutSuffixFor(jvm)
...
lazy val tests = crossProject(jvmJsPlatforms *)
  .withoutSuffixFor(jvm)
  .in(file("tests"))
  .settings(
    commonSettings,
...
lazy val xml = crossProject(platforms *)
  .withoutSuffixFor(jvm)
  .crossType(CrossType.Pure)
  .in(file("xml"))
  .settings(
