...
trait StepParsers:
  ...
  def apply[T](f: String => T)(using fpr: Regex = stepParserRegex): DelimitedStepParser[T] =
    new DelimitedStepParser1[T](f).withRegex(fpr)
  def apply[T](f: (String, String) => T)(using fpr: Regex): DelimitedStepParser[T] =
    new DelimitedStepParser2[T](f).withRegex(fpr)
  def apply[T](f: (String, String, String) => T)(using fpr: Regex): DelimitedStepParser[T] =
    new DelimitedStepParser3[T](f).withRegex(fpr)
  def apply[T](f: (String, String, String, String) => T)(using fpr: Regex): DelimitedStepParser[T] =
    new DelimitedStepParser4[T](f).withRegex(fpr)
  def apply[T](f: (String, String, String, String, String) => T)(using fpr: Regex): DelimitedStepParser[T] =
    new DelimitedStepParser5[T](f).withRegex(fpr)
  def apply[T](f: (String, String, String, String, String, String) => T)(using fpr: Regex): DelimitedStepParser[T] =
    new DelimitedStepParser6[T](f).withRegex(fpr)
  def apply[T](f: (String, String, String, String, String, String, String) => T)(using
      fpr: Regex
  ): DelimitedStepParser[T] = new DelimitedStepParser7[T](f).withRegex(fpr)
  def apply[T](f: (String, String, String, String, String, String, String, String) => T)(using
      fpr: Regex
  ): DelimitedStepParser[T] = new DelimitedStepParser8[T](f).withRegex(fpr)
  def apply[T](f: (String, String, String, String, String, String, String, String, String) => T)(using
      fpr: Regex
  ): DelimitedStepParser[T] = new DelimitedStepParser9[T](f).withRegex(fpr)
  def apply[T](f: (String, String, String, String, String, String, String, String, String, String) => T)(using
      fpr: Regex
  ): DelimitedStepParser[T] = new DelimitedStepParser10[T](f).withRegex(fpr)
  def seq[T](f: Seq[String] => T)(using fpr: Regex = stepParserRegex): DelimitedStepParser[T] =
    new DelimitedStepParserSeq[T](f).withRegex(fpr)
  ...
  class ReadAs(regex: Regex = "".r, groups: Regex = stepParserRegex):
    ...
    def and[T](f: (String, String, String, String, String, String, String, String, String, String) => T) =
      new ReadAsParser[T] {
...
trait StandardDelimitedStepParsers:
  ...
  def threeDoubles =
    StepParser((s1: String, s2: String, s3: String) => (s1.trim.toDouble, s2.trim.toDouble, s3.trim.toDouble))
...
trait StandardRegexStepParsers:
  ...
  def threeInts =
    groupAs(wholeNumber).and((s1: String, s2: String, s3: String) => (s1.trim.toInt, s2.trim.toInt, s3.trim.toInt))
  ...
  def threeDoubles = groupAs("-?" + decimalNumber).and((s1: String, s2: String, s3: String) =>
    (s1.trim.toDouble, s2.trim.toDouble, s3.trim.toDouble)
  )
