...
import org.specs2.specification.core.{SpecStructure, Env}
import control._

class TextPrinterIndentationSpec extends Specification { def is = s2"""
...
other text
"""
    TextPrinter.print(env.setArguments(Arguments("indentation", "4")).setLineLogger(logger))(spec).runOption
