...
class OperationSpec extends Specification {
  ...
  The finalizers of an operation must be executed when the operation is executed with a flatmap $finalizers1
  The finalizers of an operation must be executed when the operation is executed with an applicative $finalizers2
...
"""
  ...
  def finalizers2 =
    ...
    result === List("o1-1", "o2-1", "o1-2", "o2-2", "final1", "final2")
