...
"""
  ...
  def fromClass1 =
    createInstance[Specification]("org.specs2.reflect.FromClassName", getClass.getClassLoader) must beOk

  def fromClass2 =
    createInstance[Specification]("org.specs2.reflect.FromClassNameWithArg", getClass.getClassLoader) must beOk

  def fromNestedClass =
    createInstance[Specification]("org.specs2.reflect.ClassesSpec$FromNestedClass", getClass.getClassLoader) must beOk

  def fromObject =
    createInstance[Specification]("org.specs2.reflect.FromObjectName$", getClass.getClassLoader) must beOk

  def instantiationError =
    createInstance[Specification]("org.specs2.reflect.UserErrorSpecification", getClass.getClassLoader) must
