...
class NotNullStringsSpec extends Specification {
  def is = s2"""
...
"""
  ...
  def withClass1 =
    Array(1, 2).notNullWithClass === "Array('1', '2'): Array[java.lang.Integer]"

  def withClass2 =
    Vector(1, 2).notNullWithClass === "Vector('1', '2'): scala.collection.immutable.Vector1[java.lang.Integer]"

  def withClass3 = Map(
    1 -> "2",
    2 -> "3"
  ).notNullWithClass === "Map('1' -> '2', '2' -> '3'): scala.collection.immutable.Map$Map2[scala.Tuple2]"

  def withClass4 = Vector(
    1,
    "2"
  ).notNullWithClass === "1: java.lang.Integer2: java.lang.String: scala.collection.immutable.Vector1"

  def withClass5 = Map(
    1 -> "2",
    2 -> 3
  ).notNullWithClass === "Map(1: java.lang.Integer -> 2: java.lang.String, 2: java.lang.Integer -> 3: java.lang.Integer): scala.collection.immutable.Map$Map2"
}
