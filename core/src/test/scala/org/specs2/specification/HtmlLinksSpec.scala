...
class HtmlLinksSpec extends Specification { def is = s2"""
  ...
  ${ a("a" ~ userGuide)                             === "a <a href='org.specs2.specification.UserGuide.html'>User guide</a>" }
  ${ a("learn" ~ howTo)                             === "learn <a href='org.specs2.specification.HowTo.html'>HowTo</a>" }

  with a way to change the highlighted text
  ${ a("a" ~ ("User Guide", userGuide))             === "a <a href='org.specs2.specification.UserGuide.html'>User Guide</a>" }
  ${ a("learn" ~ ("How to", howTo))                 === "learn <a href='org.specs2.specification.HowTo.html'>How to</a>" }

  with some text after
  ${ a("a" ~ (userGuide, "for you"))                === "a <a href='org.specs2.specification.UserGuide.html'>User guide</a> for you" }
  ...
  ${ a("" ~ (userGuide, "for you"))                 === "<a href='org.specs2.specification.UserGuide.html'>User guide</a> for you" }
  ...
  with a tooltip
  ${ a("a" ~ (userGuide, "for you", "yes"))         === "a <a href='org.specs2.specification.UserGuide.html' tip='yes'>User guide</a> for you" }
  ...
  lazy val userGuide = new UserGuide
