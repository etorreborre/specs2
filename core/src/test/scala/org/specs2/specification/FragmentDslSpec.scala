...
"""
  ...
  def g1 = ((FragmentDsl.bangExample("text") ! ok) ^ f1).fragments must haveSize(2)
  def g2 = ((FragmentDsl.bangExample("text") ! ((s: String) => ok)) ^ f1).fragments must haveSize(2)
